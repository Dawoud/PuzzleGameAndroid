...
public class TextPuzzleScreen implements Screen{
	...
	private void startDialog(FirstSection first) {
		first.startDialog("I can't belive it! You solved all the puzzles!\nWell if you're so good at it, why dont you " +
				"take your amazing\nbrain with you and go see the cafeterian cook.\nI heard he has something troubling him.");
